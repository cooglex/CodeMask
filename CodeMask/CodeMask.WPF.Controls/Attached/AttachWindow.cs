...
namespace CodeMask.WPF.Controls.Attached
{
    ...
    /// Class AttachWindow
    /// </summary>
    public static class AttachWindow
    {
        /// <summary>
        ...
        public static DependencyProperty CloseCommandProperty = DependencyProperty.RegisterAttached("CloseCommand", typeof(ICommand), typeof(AttachWindow), new PropertyMetadata(null, CloseCommandPropertyChangedCallback));

        /// <summary>
        /// Identifies the CloseFailCommand dependency property.
        /// </summary>
        [SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules", "SA1401:FieldsMustBePrivate", Justification = "Public field used for Depedency Property.")]
        public static DependencyProperty CloseFailCommandProperty = DependencyProperty.RegisterAttached("CloseFailCommand", typeof(ICommand), typeof(AttachWindow), new PropertyMetadata(null));
