...
namespace CodeMask.WPF.Controls
{
    internal static class NativeMethods
    {
        ...
        {
            string path = null;
            var name = InvariantString.Format(@"AppEvents\Schemes\Apps\.Default\{0}\.current\", soundName);
            var set = new PermissionSet(null);
        ...
        {
            var systemSound = GetSystemSound(soundName);
