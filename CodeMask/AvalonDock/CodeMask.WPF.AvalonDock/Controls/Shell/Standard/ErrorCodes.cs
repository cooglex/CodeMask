...
namespace Standard
{
    ...
    internal struct Win32Error
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields")] public static readonly Win32Error
    ...
    internal struct HRESULT
    {
        ...
        public static HRESULT Make(bool severe, Facility facility, int code)
        {
            ...
            Assert.Implies((int) facility != ((int) facility & 0x1FF),
                facility == Facility.Ese || facility == Facility.WinCodec);
        ...
        public override string ToString()
        {
            ...
            {
                foreach (
                    var publicStaticField in typeof (Win32Error).GetFields(BindingFlags.Static | BindingFlags.Public))
                {
